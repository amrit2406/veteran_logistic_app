...
/// <summary>
/// Request model for updating an existing unloading register.
/// </summary>
public sealed class UpdateUnloadingRegisterRequest
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the loading register ID (optional - if provided, links to loading register).
    /// </summary>
