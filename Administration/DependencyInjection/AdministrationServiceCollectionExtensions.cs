...
public static class AdministrationServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddAdministration(this IServiceCollection services)
    {
        ...
        services.AddScoped<IDeleteRoleValidator, DeleteRoleValidator>();
        ...
        services.AddScoped<IFinancialYearCommandService, FinancialYearCommandService>();
        services.AddScoped<ICreateFinancialYearValidator, CreateFinancialYearValidator>();
