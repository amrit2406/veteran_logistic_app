...
/// <summary>
/// ViewModel for the Add Customer screen.
/// </summary>
public sealed partial class AddCustomerViewModel : ViewModelBase
{
    ...
    public AddCustomerViewModel(ICustomerCommandService customerCommandService, INavigationService navigationService)
    {
    ...
    private async Task SaveAsync()
    {
        ...
        SetBusy("Creating customer...");
        var result = await _customerCommandService.CreateCustomerAsync(request).ConfigureAwait(false);
        ClearBusy();
        ...
        {
            ValidationError = result.ErrorMessage ?? "Failed to create customer.";
        }
    }
