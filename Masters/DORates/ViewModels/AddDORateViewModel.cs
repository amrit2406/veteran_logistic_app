...
/// <summary>
/// ViewModel for the Add DO Rate screen.
/// </summary>
public sealed partial class AddDORateViewModel : ViewModelBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AddDORateViewModel"/> class.
    /// </summary>
    ...
    public AddDORateViewModel(IDORateCommandService doRateCommandService, ISourceDestinationQueryService sourceDestinationQueryService, IDummyLookupService dummyLookupService, INavigationService navigationService)
    {
    ...
    private async Task SaveAsync()
    {
        ...
        var request = new CreateDORateRequest
        {
        ...
        SetBusy("Creating DO rate...");
        var result = await _doRateCommandService.CreateDORateAsync(request).ConfigureAwait(false);
        ClearBusy();
        ...
        {
            ValidationError = result.ErrorMessage ?? "Failed to create DO rate.";
        }
    }
...
/// <summary>
/// Lookup item for source destinations.
/// </summary>
public sealed class SourceDestinationLookupItem
{
