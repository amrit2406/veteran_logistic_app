...
/// <summary>
/// Validator for vehicle creation requests.
/// </summary>
public sealed class CreateVehicleValidator : ICreateVehicleValidator
{
    ...
    /// <inheritdoc />
    public ValidationResult Validate(CreateVehicleRequest request)
    {
