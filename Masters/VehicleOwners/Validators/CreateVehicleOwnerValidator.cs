...
/// <summary>
/// Validator for vehicle owner creation requests.
/// </summary>
public sealed class CreateVehicleOwnerValidator : ICreateVehicleOwnerValidator
{
    ...
    /// <inheritdoc />
    public ValidationResult Validate(CreateVehicleOwnerRequest request)
    {
