...
/// <summary>
/// Represents an unloading register entry in the system.
/// </summary>
public class UnloadingRegister : BaseEntity
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets whether the unloading register has been soft-deleted.
    /// </summary>
    public bool IsDeleted { get; set; } = false;

    /// <summary>
    /// Gets or sets the timestamp when the unloading register was soft-deleted.
    /// </summary>
    public DateTime? DeletedOn { get; set; }

    /// <summary>
    /// Gets or sets the user who created the unloading register.
    /// </summary>
    public string CreatedBy { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the user who last modified the unloading register.
    /// </summary>
