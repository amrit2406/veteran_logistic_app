...
/// <summary>
/// Represents a Delivery Order (DO) rate setup for a specific route.
/// </summary>
public class DORate : BaseEntity
{
    /// <summary>
    /// Gets or sets the consignor ID (dummy lookup for now).
    /// </summary>
    public int ConsignorId { get; set; }

    /// <summary>
    /// Gets or sets the consignee ID (dummy lookup for now).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets whether the DO rate has been soft-deleted.
    /// </summary>
    public bool IsDeleted { get; set; } = false;

    /// <summary>
    /// Gets or sets the timestamp when the DO rate was soft-deleted.
    /// </summary>
    public DateTime? DeletedOn { get; set; }

    /// <summary>
    /// Gets or sets the user who created the DO rate.
    /// </summary>
    public string CreatedBy { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the user who last modified the DO rate.
    /// </summary>
    public string ModifiedBy { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the source location navigation property.
    /// </summary>
    public SourceDestination? Source { get; set; }

    /// <summary>
    /// Gets or sets the destination location navigation property.
    /// </summary>
