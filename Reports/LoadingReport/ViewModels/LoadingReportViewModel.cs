...
namespace veteran_logistic.Reports.LoadingReport.ViewModels;

/// <summary>
/// ViewModel for the Loading Report screen.
/// </summary>
public sealed partial class LoadingReportViewModel : ViewModelBase
{
    private readonly ILoadingReportQueryService _loadingReportQueryService;
    ...
    private readonly ILoadingReportPdfExporter _pdfExporter;
    private readonly ILoadingReportExcelExporter _excelExporter;
    private readonly INotificationService _notificationService;
    private string _searchText = string.Empty;
    private string _sortBy = "loadingdate";
    private bool _sortAscending = true;
    private LoadingReportFilter _filter = new();
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LoadingReportViewModel"/> class.
    /// </summary>
    /// <param name="loadingReportQueryService">The loading report query service.</param>
    ...
    public LoadingReportViewModel(
        ILoadingReportQueryService loadingReportQueryService,
        ...
        ILoadingReportPdfExporter pdfExporter,
        ILoadingReportExcelExporter excelExporter,
        INotificationService notificationService)
    {
        _loadingReportQueryService = loadingReportQueryService ?? throw new ArgumentNullException(nameof(loadingReportQueryService));
    ...
    /// <summary>
    /// Gets the collection of loading report items to display.
    /// </summary>
    public ObservableCollection<LoadingReportItem> ReportItems { get; } = new();

    /// <summary>
    /// Gets the calculated totals for the report.
    /// </summary>
    public LoadingReportTotals Totals { get; } = new();
    ...
    /// </summary>
    public LoadingReportFilter Filter
    {
        get => _filter;
    ...
    /// <summary>
    /// Command to sort by loading weight.
    /// </summary>
    [RelayCommand]
    private async Task SortByLoadingWeightAsync()
    {
        if (SortBy == "loadingweight")
        {
            SortAscending = !SortAscending;
        }
        else
        {
            SortBy = "loadingweight";
            SortAscending = true;
        }
    }
    ...
    private async Task ExportToPdfAsync()
    {
        var saveFileDialog = new SaveFileDialog
        {
            ...
            Title = "Save Loading Report as PDF",
            FileName = $"LoadingReport_{DateTime.Now:yyyyMMdd_HHmmss}.pdf"
        };
    ...
    private async Task ExportToExcelAsync()
    {
        var saveFileDialog = new SaveFileDialog
        {
            ...
            Title = "Save Loading Report as Excel",
            FileName = $"LoadingReport_{DateTime.Now:yyyyMMdd_HHmmss}.xlsx"
        };
    ...
    private void UpdateReportItems(IEnumerable<LoadingReportItem> items)
    {
        var dispatcher = System.Windows.Application.Current?.Dispatcher;
        if (dispatcher == null || dispatcher.CheckAccess())
        {
    ...
    /// </summary>
    /// <param name="items">The report items to update.</param>
    private void UpdateReportItemsInternal(IEnumerable<LoadingReportItem> items)
    {
        ReportItems.Clear();
    ...
    private void UpdateTotals(LoadingReportTotals totals)
    {
