namespace veteran_logistic.Reports.LoadingReport.DTOs;

/// <summary>
/// Represents a loading report item for display in the loading report grid.
/// </summary>
public sealed class LoadingReportItem
{
    /// <summary>
